...
with open('/Users/dharit/Downloads/df_new.txt') as f:
...
plt.title("K-means Clustering Results on Aug train data(14 Clusters)")
plt.savefig("cluster_plot_2.png")
...
df_2.to_csv('df3_new.txt', sep='\t', index=False)
